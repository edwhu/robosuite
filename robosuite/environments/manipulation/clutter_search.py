...
from robosuite.utils.mjcf_utils import CustomMaterial, IMAGE_CONVENTION_MAPPING
...
class ClutterSearch(SingleArmEnv):
    ...
    def _get_observations(self, force_update=False):
        """ We only have RGB image of agent view,  we need to render segmentation mask for 
        agentview, eye_in_hand, and underview and add it to the observation.
        """
    ...
    def reward(self, action=None):
        ...
        #     segmentation=False,
        # )
        # imageio.imwrite("/tmp/rgb.png", rgb)
        # import ipdb; ipdb.set_trace()
    ...
    def _get_placement_initializer(self):
        ...
        # distractor objects should be above the normal objects
        self.placement_initializer.append_sampler(
            sampler=UniformRandomSampler(
                name="DistractorObjectSampler",
                mujoco_objects=self.distractor_objects,
                x_range=[-bin_x_half, bin_x_half],
                y_range=[-bin_y_half, bin_y_half],
                rotation=None,
                rotation_axis="z",
    ...
    def _load_model(self):
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=self.visual_objects + self.objects + self.distractor_objects,
        )
...
class ClutterSearchSingleStatePosition(ClutterSearch):
    """
    Use states as input
    """
    def __init__(self, **kwargs):
